...
public class Change_Add_Associations_New extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      /*  mFab.hide(false);
        ...
        int count = 0;
        while (associationLongNameList.size() > count) {
            Log.d(TAG, "Assoc long name ----> " + associationLongNameList.get(count));
            Log.d(TAG, "Assoc member type ----> " + associationMemberTypeList.get(count));
            Log.d(TAG, "Assoc code ----> " + associationCodeForParseList.get(count));
            count++;
        }

        Log.d(TAG, "Logged in to ----> " + installation.get("AssociationCode"));


        int index = associationCodeForParseList.indexOf(installation.get("AssociationCode"));

        Log.d(TAG, "assoc code for ParseList index ----> " + index);
...
/*
        ...
        associationLongNameList.remove(index);
        associationCodeForParseList.remove(index);
        associationMemberTypeList.remove(index);
        ...
        if (associationLongNameList.size() > 0) {
...
*/
                    ...
                    queryAssociations.getFirstInBackground(new GetCallback<ParseObject>() {
                        ...
                        public void done(ParseObject object, ParseException e) {
                            ...
                            mainActivity.setClass(Change_Add_Associations_New.this, MainActivity.class);
    ...
    public void AddChangeAssoc(View v) {
        ...
        addChangeActivity.setClass(Change_Add_Associations_New.this, PopEnterPasscode.class);
