...
import comapps.com.myassociationhoa.maintenance.MaintenanceComment;
...
class EditMaintenanceAdapter extends ArrayAdapter<MaintenanceObject> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.textviewlist, parent, false);
