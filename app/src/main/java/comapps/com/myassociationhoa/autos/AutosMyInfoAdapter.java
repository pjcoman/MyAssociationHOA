    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            public void onClick(View v) {
                ...
                autoAddActivity.setClass(context.getApplicationContext(), PopAutosAddAuto.class);
                autoAddActivity.putExtra("AUTOFOREDIT", jsonAutoObject);
                autoAddActivity.putExtra("FOREDIT", true);
                context.startActivity(autoAddActivity);
        ...
        convertView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                autoAddActivity.setClass(context.getApplicationContext(), PopAutosAddAuto.class);
                autoAddActivity.putExtra("AUTOFOREDIT", jsonAutoObject);
                autoAddActivity.putExtra("FORDELETE", true);
                context.startActivity(autoAddActivity);
                ((Activity)context).finish();
